...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    acknowledged INTEGER DEFAULT 0,  -- BOOLEAN as INTEGER
...
-- Create updated_at trigger function (SQLite doesn't have stored procedures like PostgreSQL)
...
CREATE INDEX IF NOT EXISTS idx_project_summary_status ON project_summary(status);
CREATE INDEX IF NOT EXISTS idx_analysis_summary_status ON analysis_summary(status);
CREATE INDEX IF NOT EXISTS idx_application_summary_project ON application_summary(project_id);
